...
Data::Data(int T, int S, std::vector<int> c, int E, int P, int X, std::vector<std::vector<int>> a, std::vector<std::vector<int>> b, std::vector<int> d, int I, std::vector<std::vector<int> > i, int N, std::vector<std::vector<int> >f) :
		T(T),
		S(S),
		c(c),
		E(E),
...
void Data::print() {
	...
	std::cout << std::endl;
	std::cout << "Nombre de période forcée: " << this->getN() << std::endl;
